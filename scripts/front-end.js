...
$(function () {
    ...
    function processImage(anImage, event) {
    ...
    function handleFile(event) {
        ...
        reader.onload = function (event) {
            ...
            if (extension === 'dcm') {
                ...
                $(origWrapper).height(anImage.height);
                $(origWrapper).width(anImage.width);
                orig.canvas.width = anImage.width;
                orig.canvas.height = anImage.height;
