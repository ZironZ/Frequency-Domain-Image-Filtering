var Curve = function (canvas, options) {
    ...
    this.triggerChartListener = function () {
        this.chartListener();
        this.triggerChangeListeners();
    };
    ...
    var moveInProgress = function (event) {
        event.preventDefault();
    ...
    this.setupListeners = function() {
        ...
        canvas.addEventListener('mousemove', moveInProgress);
    ...
    this.removeListeners = function() {
        canvas.removeEventListener('mousedown', moveStart);

        canvas.removeEventListener('mousemove', moveInProgress);
